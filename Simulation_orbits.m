...
epoch = 2.125677661020000e+11;
disp("Mission start time:")
disp(datetime(epoch/(24*60*60),'convertfrom','juliandate'))
...
disp(datetime(object1_depart_time/(24*60*60),'convertfrom','juliandate'))
...
disp(datetime(object2_arrive_time/(24*60*60),'convertfrom','juliandate'))
>>>>>>> 0ea11934abd0752aff5e91f0cc20135563018a5c
...
disp(datetime(object2_depart_time/(24*60*60),'convertfrom','juliandate'))
...
disp(datetime(object3_arrive_time/(24*60*60),'convertfrom','juliandate'))
...
disp(datetime(object3_depart_time/(24*60*60),'convertfrom','juliandate'))
